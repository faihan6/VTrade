...
class _ProductEditPageState extends State<ProductEditPage> {
  ...
  Widget build(BuildContext context) {
    ...
    DetailsController.text = widget.product.details;
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async
        {
          ...
          String createdBy = widget.product.createdBy;
          String imgLoc;
          if(chosenFilePath == '')
            imgLoc = widget.product.imageLocation;
          else
            imgLoc = chosenFilePath;
          int price;
              ...
              && details != '' && imgLoc != '')
          {
            ...
            DBProvider.instance.updateProduct(product);

            DBProvider.instance.queryAllProducts();
            setState(() {
              statusText = "Product Added!";
            });
            Navigator.pushAndRemoveUntil(context,
                MaterialPageRoute(builder: (context) => HomePage(widget.product.createdBy)),
                    (route) => false);
